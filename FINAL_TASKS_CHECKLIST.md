...
- [x] Add background music loop plus shift/day stingers. — Gameplay-only medium-loud bassline loop enabled in `GameScene`; menu remains silent; shift/day transition stinger cues handled by procedural transition tones.
